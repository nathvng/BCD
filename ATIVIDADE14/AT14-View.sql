...
SELECT nome_cliente,
YEAR(data_nascimento) AS ano_aniversario, MONTH(data_nascimento) as mes_aniversario
FROM tb_cliente;

SELECT * FROM vw_clientes_nascimento;

DROP VIEW vw_clientes_nascimento;
